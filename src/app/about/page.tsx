    ...
    <main className="bg-blue-50">
      ...
      <section className="flex-col flex gap-6 py-6">
        ...
        <AnimatedContainer className="flex flex-col gap-4 items-center bg-red-50 py-4">
          ...
          <div className="leading-loose flex flex-col lg:flex-row gap-6 w-11/12 lg:w-10/12 mx-auto">
            ...
            <Image src={schoolChildren} alt="About our School" className="brightness-70 rounded-md lg:w-1/2" />
          </div>
